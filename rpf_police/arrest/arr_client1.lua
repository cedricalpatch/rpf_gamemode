				...
				if distanceToTarget <= 15 then
					...
					if IsPedInAnyVehicle(target) then -- if the target ped is in a vehicle...
						...
						if target == stoppedDriver then -- and if the ped is a driver during a pullover...
							ShowNotification("~o~Officer:~w~ Dessend du vehicule ! Tous de suite depeche toi !")
							...
							if resistExitChance > 25 then
								...
								Citizen.Wait(500)
								local driverResponseResist = {"Non je dessend pas !","Va te faire enculer !","Pas aujourduit !","Merde !","Uhm.. Non.","Get away from me!","Pig!","No.","Never!"}
