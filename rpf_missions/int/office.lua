...
Citizen.CreateThread(function()
	while true do
		...
		if GetDistanceBetweenCoords(playerCoords, -50.148, -791.495, 44.225-1.0001) <= 50.0 then
			DrawMarker(27, -50.148, -791.495, 44.225-1.0001, 0, 0, 0, 0, 0, 0, 4.0, 4.0, 2.0, 13, 232, 255, 155, 0, 0, 2, 0, 0, 0, 0)
		end
		...
		if GetDistanceBetweenCoords(playerCoords, -81.148, -801.68, 243.39-1.0001) <= 5.0 then
			--TriggerEvent("fs_freemode:displayHelp", i18n.translate("enter_pc"))
			--DrawMarker(1, -81.148, -801.68, 243.39-1.0001, 0, 0, 0, 0, 0, 0, 0.5, 0.5, 0.5, 13, 232, 255, 155, 0, 0, 2, 0, 0, 0, 0)
		end
