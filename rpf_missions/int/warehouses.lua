...
Citizen.CreateThread(function()
	while true do
		...
		DrawMarker(20, 2554.7685546875,6194.5341796875,165.39990234375+0.2, 0.0, 0.0, 0.0, 180.0, 0.0, 180.0, 1.5, 1.5, 1.0, 240, 200, 80, 180, false, true, 2, false, false, false, false)
		if GetDistanceBetweenCoords(playerCoords.x, playerCoords.y, playerCoords.z, 2554.7685546875,6194.5341796875,165.39990234375, true) <= 2.0 then
		...
		if GetDistanceBetweenCoords(playerCoords.x, playerCoords.y, playerCoords.z, 1065.430, -3182.969, -39.163, true) <= 5.0 then
			...
			if IsControlJustPressed(0, 38) then
				...
				SetEntityCoords(PlayerPedId(), 2554.7685546875,6194.5341796875,165.39990234375, 239.736)
		...
		DrawMarker(20,-5866.5571289063,1146.9984130859,13.196561813354+0.2, 0.0, 0.0, 0.0, 180.0, 0.0, 180.0, 1.5, 1.5, 1.0, 240, 200, 80, 180, false, true, 2, false, false, false, false)
		if GetDistanceBetweenCoords(playerCoords.x, playerCoords.y, playerCoords.z, -5866.5571289063,1146.9984130859,13.196561813354, true) <= 2.0 then
			TriggerEvent("fs_freemode:displayHelp", i18n.translate("enter_warehouse"))
			if IsControlJustPressed(0, 38) then
		...
		if GetDistanceBetweenCoords(playerCoords.x, playerCoords.y, playerCoords.z, 1088.803, -3188.257, -38.993, true) <= 1.0 then
			...
			if IsControlJustPressed(0, 38) then
				...
				SetEntityCoords(PlayerPedId(), -5866.5571289063,1146.9984130859,13.196561813354)
