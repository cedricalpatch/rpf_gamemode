...
local garages = { 
    ...
    [7]= { locked = false, camera = {x = 210.13357543945, y = 5186.3081054688, z = -87.374923706055, heading = 90.00}, driveout = { x = 180.41987609863, y = 5180.1166992188, z = -89.305786132813, heading = 86.97}, drivein = { x = 180.41987609863, y = 5180.1166992188, z = -89.305786132813, heading = 273.54}, outside = {191.51594543457, y = 5180.091796875, z = -89.214706420898, heading = 90.00}, inside = {x = 203.69505310059, y = 5180.0043945313, z = -89.615516662598, heading = 273.00} }
}
									...
									if pos.locked then
										...
										if IsControlJustPressed(1,201) then
											...
											DriveInGarage()
												...
												TriggerEvent("fs_freemode:displayHelp", "Presse ~INPUT_FRONTEND_ACCEPT~ Pour modifier ton ~g~Vehicule~w~ Sauvegarde en suite dans un parking !",4,1,0.5,0.8,1.0,255,255,255,255)
										end
									end
								else
