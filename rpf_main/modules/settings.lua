...
Settings.afkTimeout = 3000 --in seconds
...
Settings.spawn = {
	points = {
		{  x = -1043.9459228516, y = -2748.859375, z = 21.3634262084 },
	},
	deathTime = 6000,
	timeout = 30000,
...
Settings.infinitePlayerStamina = false
...
Settings.castle = {
	duration = 900000,
	places = {
		{ x = 2927.6618652344, y = -3753.2727050781, z = 141.59197998047 },
		--{ x = 2838.8081054688, y = -3795.84375, z = 158.26499938965 },
		{ x = 2708.0893554688, y = -3860.3210449219, z = 140.48551940918 },
...
Settings.mostWanted = {
	...
	notification = {
		timeout = 45000,
		messages = {
			'Toi, mon ami a fini par te retrouve... tu as rejoint la societe de Morons les force de police arrive !',
			'Super ton nom ! ...mai j ai du male a l\'épelé.',
