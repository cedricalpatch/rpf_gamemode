...
function Scoreboard.DisplayThisFrame()
	...
	Gui.SetTextParams(0, tableHeaderTextColor, headerScale, false, false, true)
	Gui.DrawText("", { ['x'] = tableCashHeader.x, ['y'] = tableHeaderText.y })
	...
	Gui.SetTextParams(0, tableHeaderTextColor, headerScale, false, false, true)
	Gui.DrawText("XP", { ['x'] = tableKillsHeader.x, ['y'] = tableHeaderText.y })

	-- Draw "DEATHS" header
	Gui.DrawRect(tableDeathsHeader, tableDeathsWidth, tableHeight, tableHeaderColor)
	Gui.SetTextParams(0, tableHeaderTextColor, headerScale, false, false, true)
	Gui.DrawText("MORTS", { ['x'] = tableDeathsHeader.x, ['y'] = tableHeaderText.y })
